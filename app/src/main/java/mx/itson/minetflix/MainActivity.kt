...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter2 = PeliculaAdapter(this, peliculas)
        ...
        fun cargarPeliculas(){
        //Cargar películas
        peliculas.add(Pelicula("1917",R.drawable.p1917,R.drawable.p1917header,"During World War I, two young British soldiers receive an order, apparently impossible to execute: in a race against the clock, they must infiltrate enemy territory to deliver a message that could save thousands of comrades."))
        ...
        peliculas.add(Pelicula("Men in black",R.drawable.mib,R.drawable.mibheader,"Men in black are special agents who are part of a totally secret unit of government. Your mission is to control the aliens. Two of these agents discover a galactic terrorist who intends to end Earth."))
    ...
    fun cargarSeries(){
        ...
        series.add(Pelicula("Suits",R.drawable.suits,R.drawable.suitsheader,"A young man is hired as an assistant in a prestigious law firm in New York, lying flagrantly in his CV, but his boss to verify his great intelligence and legal knowledge, decides to turn a blind eye and allows him to continue working with him, as  You can see in the series promo."))
